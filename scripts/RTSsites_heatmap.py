...
# Save dataframe
df_map_regions.to_csv("{}.dataframe.csv".format(args.output_prefix))

# Plot heatmap
plt.figure(figsize=(20, 10))
sns.heatmap(df_map_regions, cmap="Blues", vmax=1, vmin=0)
plt.savefig("{}.heatmap.png".format(args.output_prefix))
